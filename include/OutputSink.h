...
/**
 * @brief Abstract output sink for routing trade signals to a destination.
 *
...
public:
    ...
    /**
     * @brief Emit a single trade signal to this sink.
     *
     * @param sig Fully populated TradeSignal to write.
     */
    virtual void emit(const TradeSignal& sig) = 0;

    /**
     * @brief Flush any internally buffered output to the underlying destination.
     *
